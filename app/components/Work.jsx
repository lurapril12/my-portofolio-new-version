    ...
    <motion.div
      ...
      id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
        ...
        <motion.h4
          ...
          className='text-center mb-2 font-Ovo'>My portofolio
        </motion.h4>
        ...
        <motion.p
          ...
          className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
            Welcome to my web portofolio page. Here you can see some of the projects I have my expertise in fullstack development and front-end development.
        </motion.p>
